...
async function renderDataToHTML(event, arg) {
    switch (arg.line.type) {
        ...
        return;
        case 'oneInchDoubleSingleBarCode':
            try {
                body.append(`
                <div >
        ...
        case 'customDoubleBarcode':
            try {
                body.append(`
                <div>
                <table style="${arg.line.style.mainDivStyle}">
                <tr  style='margin-left: auto; margin-right: auto ;font-family:Helvetica, sans-serif;border: none;'>
                <td > 
